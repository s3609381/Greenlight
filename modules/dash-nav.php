<div class="col-md-2">
    ...
    <div class="list-group">
        ...
        <div id="toggleNav" style="display:none">
            ...
            <button type="button" class="list-group-item" onclick="window.location='/dashboard/create-enhanced-light.php';">Enhanced Light</button>
        </div>
        
        <button type="button" class="list-group-item" onclick="window.location='/logout.php';">Sign Out</button>
